...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"></script>
    <!-- Favicon icon -->
    <link rel="icon" href="{{ url('/dist/assets/images/favicon.ico')}}" type="image/x-icon">
			...
			<div class="navbar-content scroll-div " >
				...
				<div class="">
					<div class="main-menu-header">
						<img class="img-radius" src="{{url('/dist/assets/images/user/avatar-2.jpg')}}" alt="User-Profile-Image">
	...
	<header class="navbar pcoded-header navbar-expand-lg navbar-light header-dark">
				...
				<div class="m-header">
					...
					<a href="#!" class="b-brand">
						...
						<img src="{{ url('/dist/assets/images/logo.png')}}" alt="" class="logo">
						<img src="{{ url('/dist/assets/images/logo-icon.png')}}" alt="" class="logo-thumb">
					</a>
